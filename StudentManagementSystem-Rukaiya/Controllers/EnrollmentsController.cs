...
namespace StudentManagementSystem_Rukaiya.Controllers
{
    ...
    public class EnrollmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentId,StudentId,CourseId,EnrollmentDate,EnrollmentStatus,GPA,ExamMarks,Grade")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnrollmentId,StudentId,CourseId,EnrollmentDate,EnrollmentStatus,GPA,ExamMarks,Grade")] Enrollment enrollment)
        {
